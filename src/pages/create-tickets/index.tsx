        ...
        <div className={styles.content}>
          ...
          <form onSubmit={handleSubmit(onSubmitFunction)}>
            ...
            <div className={styles.inputWrapper}>
              ...
              <FontAwesomeIcon icon={faUser} size={'sm'} className={styles.icon} />
            </div>
            <label>Email</label>
            <div className={styles.inputWrapper}>
              <input {...register('client_email')}  type="text" placeholder="Digite o email"/>
              <FontAwesomeIcon icon={faEnvelope} size={'sm'} className={styles.icon} />
            </div>
            <label>Telefone</label>
            <div className={styles.inputWrapper}>
              <input {...register('client_phone_number')}  type="text" placeholder="Digite o número de telefone"/>
              <FontAwesomeIcon icon={faMobilePhone} size={'sm'} className={styles.icon} />
            </div>
